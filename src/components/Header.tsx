  ...
  return (
    <>
      ...
      <header className="bg-blue-900 text-white dark:bg-gray-800 p-4 relative z-50">
        ...
        {menuAberto && (
          <div className="absolute right-0 top-16 bg-blue-900 dark:bg-gray-800 text-white w-48 flex flex-col space-y-4 py-4 px-6 sm:hidden shadow-lg rounded-bl">
            <Link href="/" onClick={() => setMenuAberto(false)}>Início</Link>
            <Link href="/secretaria/vigilancia" onClick={() => setMenuAberto(false)}>Vigilância em Saúde</Link>
          </div>
        )}
      </header>
    </>
